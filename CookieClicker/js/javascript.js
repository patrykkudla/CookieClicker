(function() {
     ...
     let farmValue = 1000, farmLevel = 0, farmProductionCPS = 0, farmCPS = 0.8;
     let bakeryValue = 5000, bakeryLevel = 0, bakeryProductionCPS = 0, bakeryCPS = 2.2;
     let mineValue = 10000, mineLevel =0, mineProductionCPS = 0, mineCPS = 4.8;
     ...
     idb_request.addEventListener("success", function(event) {      
         ...
         //Function to display our values like total cookie amount, cookies per second, cursor,grandma values. all values of cursor grandma farm bakery and mine can be moved to the "loading page effect" but allso need to be added to every addEventListener('click'), when efficiency is low.
...
//Loading page effect and centerSide images adding(saved) after refreshing page or loading page. *"here can be moveed"
